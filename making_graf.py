...
ax.text(130, 2.5,  "Время зарядки = 56.18 с", fontsize = 12)
ax.text(130, 2.4,  "Время разрядки = 146.25 с", fontsize = 12)

ax.plot(times, data, c = 'red', linewidth = 1, label = "V(t)",marker = 'o', markevery = 30)
